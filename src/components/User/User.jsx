...
const User = ({person}) => {
  ...
  const serverPublic = process.env.REACT_APP_PUBLIC_FOLDER;   //stores the url of the server side pictures folder 
  const handleFollow = ()=>{
    following
  ...
  return (
      <div className="follower">
          <div>  <Link to={`/profile/${person._id}`} style={{ textDecoration: "none", color: "inherit" }}>
